...
namespace HaikyuuGame.Gameplay.UI
{
    public sealed class PlayableCoreHud : MonoBehaviour
    {
        ...
        private void OnGUI()
        {
            GUI.Box(new Rect(16f, 16f, 590f, 176f), "Playable Core 0.3 - Anime Volleyball");
            ...
            GUI.Label(new Rect(32f, 116f, 550f, 24f), _message);
            GUI.Label(new Rect(32f, 140f, 550f, 24f), "Move WASD | Jump Space | Context F/J | Z Receive | X Set | C Spike | V Block | R Reset");
        }
    }
}
